...
export const AppIcon = memo(function AppIcon({ size = 32 }: { size?: number }) {
  ...
  const sheen = `${id}-s`;
  return (
    <svg className="app-icon" width={size} height={size} viewBox="0 0 32 32" role="img" aria-label="Tabula">
      <defs>
      ...
      <rect x="0.5" y="0.5" width="31" height="31" rx="8.5" fill="none" stroke="#fff" strokeOpacity="0.35" />
