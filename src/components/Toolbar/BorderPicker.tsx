...
const BORDER_PRESETS: BorderPreset[] = [
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor">
        <rect x="1" y="1" width="14" height="14" strokeWidth="0.5" strokeDasharray="2 2" opacity="0.3" />
  ...
  },
  {
    ...
    borders: undefined,
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="0.5" strokeDasharray="2 2" opacity="0.4">
        <rect x="1" y="1" width="14" height="14" />
      </svg>
    ),
  },
...
export const BorderPicker = memo(function BorderPicker({
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      {isOpen && (
        <FloatingPanel anchorRef={containerRef} panelRef={dropdownRef} className="glass-surface rounded-xl p-2 w-[124px] animate-slide-down">
